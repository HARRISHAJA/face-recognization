...
class MainUI(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.title("Face Recognition Project By mohamed harris")
...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label3 = tk.Label(self, text="REC", font=self.controller.title_font, fg="#263942")
...
class PageThree(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.myname = tk.Label(self, text="Project By mohamed harris", font='Helvetica 12 bold', fg="#263942")
